...
// Path to grunt.
exports.gruntPath = function(baseDir) {
  var gruntPath;
  try {
...
// Return true if Gruntfile.js exists.
exports.gruntInstallable = function(baseDir) {
  var gruntFilePath = 'Gruntfile.js';
  if (baseDir) {
    gruntFilePath = baseDir + '/' + gruntFilePath;
  }
  return require('fs').existsSync(gruntFilePath);
};
